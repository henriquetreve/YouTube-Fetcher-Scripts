...
def main():
    ...
    if export_format == 'csv':
        filename = os.path.join(directory, f'youtube_videos_{sanitized_query}.csv') if directory else f'youtube_videos_{sanitized_query}.csv'
        export_to_csv(videos, filename)
    elif export_format == 'excel':
        filename = os.path.join(directory, f'youtube_videos_{sanitized_query}.xlsx') if directory else f'youtube_videos_{sanitized_query}.xlsx'
